  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glow-words': {
          '0%, 100%': { opacity: 0, transform: 'scale(1) rotate(var(--rotation-deg))', textShadow: '0 0 5px currentColor' },
          '50%': { opacity: 0.15, transform: 'scale(1.05) rotate(var(--rotation-deg))', textShadow: '0 0 15px currentColor' },
        },
      },
      animation: {
