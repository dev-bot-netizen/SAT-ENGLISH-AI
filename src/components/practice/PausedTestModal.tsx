        ...
        >
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <button
                        onClick={onResume}
                        className="w-full bg-brand-violet text-white font-bold py-3 px-4 rounded-lg hover:bg-brand-lavender hover:text-brand-indigo transition-colors duration-300"
                    >
                        Resume Test
                    </button>
                    <button
                 ...
                 <button
                    onClick={onClose}
                    className="text-white/60 hover:text-white font-semibold text-sm transition-colors mt-6"
                >
                    Cancel
                </button>
            </div>
