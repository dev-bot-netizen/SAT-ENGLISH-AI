...
const AdaptiveTestModal: React.FC<AdaptiveTestModalProps> = ({ 
    ...
    return (
        <div 
            className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex flex-col p-4 sm:p-6 lg:p-8"
            role="dialog"
            aria-modal="true"
            ...
            <div className="bg-gray-900 rounded-xl border border-gray-800 flex flex-col h-full overflow-hidden">
                ...
                <div className="flex-shrink-0 flex items-center justify-between p-4 border-b border-gray-800">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-gray-400">Select 1-20 questions to generate a new 20-question test targeting your weak areas.</p>
                    </div>
                ...
                {/* Footer */}
                {!isLoading && (
                    <div className="flex-shrink-0 p-4 border-t border-gray-800 bg-gray-900/80 backdrop-blur-sm">
                        {userProfile && (
                            <div className="mb-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button 
                                ...
                                className="bg-purple-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-purple-500 disabled:bg-gray-700 disabled:cursor-not-allowed transition-colors duration-300 flex items-center justify-center space-x-2"
                            >
